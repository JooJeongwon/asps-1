...
test('HTTP serves assets and API but never private files',async()=>{
 ...
 try{
  for(const [path,type] of [['/','text/html'],['/characters.js','text/javascript'],['/assets/characters/jeong-chihoon-anime.png','image/png'],['/assets/characters/joo-jeongwon-anime.png','image/png'],['/assets/characters/park-jinhwan-anime.png','image/png'],['/assets/characters/nam-seongsu-anime.png','image/png'],['/routes.js','text/javascript'],['/game.js','text/javascript'],['/play.html','text/html'],['/play.css','text/css'],['/story.js','text/javascript'],['/vendor/monogatari/monogatari.js','text/javascript'],['/vendor/monogatari/monogatari.css','text/css'],['/assets/characters/jeong-chihoon.jpeg','image/jpeg'],['/assets/characters/joo-jeongwon.jpeg','image/jpeg'],['/assets/characters/park-jinhwan.jpg','image/jpeg'],['/assets/characters/nam-seongsu.png','image/png'],['/assets/yeonbun-scenes.png','image/png'],['/assets/favicon.svg','image/svg+xml'],['/api/highlight','application/json']]){
