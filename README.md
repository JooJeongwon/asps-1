...
일상 선택은 반응과 호감도만 바꾼 뒤 같은 스토리로 합류한다. CUT 05·08·11·14에서 네 명의 프로필을 해금하고, CUT 19에서는 호감도와 관계없이 네 명 모두 선택할 수 있다. CUT 20의 4개 엔딩 뒤 로판 일러스트·팀 역할과 MEMBER PROFILE / OUR PROJECT / GITHUB를 제공하는 `/team.html`로 이어진다.
